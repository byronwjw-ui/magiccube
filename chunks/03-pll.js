PLL_FORMULAS.push(
  pllEntry(1, 'Aa', 'Aa Perm', 'Corners Only', "x (R' U R') D2 (R U' R') D2 R2 x'", 1, ["y' x' (R2 D2) (R' U' R) D2 (R' U R')"], '右后顺时针三角换'),
  pllEntry(2, 'Ab', 'Ab Perm', 'Corners Only', "x R2' D2 (R U R') D2 (R U' R) x'", 1, ["y2 x (R2 D2 R U R' D2 R U' R)"]),
  pllEntry(3, 'E',  'E Perm',  'Corners Only', "x' (R U' R' D) (R U R' D') (R U R' D) (R U' R' D') x", 3),
  pllEntry(17, 'Ua', 'Ua Perm', 'Edges Only', "(R U' R U R U) (R U' R' U' R2)", 1, ["M2 U M U2 M' U M2"], '前棱逆时针三换'),
  pllEntry(18, 'Ub', 'Ub Perm', 'Edges Only', "R2 U (R U R' U') (R' U' R' U R')", 1, ["M2 U' M U2 M' U' M2"], '前棱顺时针三换'),
  pllEntry(9,  'H',  'H Perm',  'Edges Only', "M2 U M2 U2 M2 U M2", 1, [], '对面棱对换'),
  pllEntry(21, 'Z',  'Z Perm',  'Edges Only', "M' U M2 U M2 U M' U2 M2", 1, ["M2 U M2 U M' U2 M2 U2 M'"], '相邻棱对换'),
  pllEntry(10, 'Ja', 'Ja Perm', 'Adjacent Swap', "(R' U L' U2) (R U' R' U2 R L)", 2, ["x R2 F R F' R U2 r' U r U2 x'"]),
  ...
  pllEntry(12, 'Na', 'Na Perm', 'Diagonal Swap', "(R U R' U) (R U R' F') (R U R' U') (R' F R2 U' R' U2 R U' R')", 3, ["z U R' D R2 U' R D' U R' D R2 U' R D' z'"]),
