(function(){
  function featureRow(text, free, pro){
    return '<tr>' +
      ...
      '<td class="center" style="padding:10px 0;border-bottom:1px solid var(--line);color:var(--blue);font-weight:600">' + (pro?'✓':'—') + '</td></tr>';
  }
  window.renderPricing = function(){
    ...
    root.innerHTML = '<section class="center">' +
      ...
      '<div class="card"><div class="text-sm t-muted">免费</div>' +
      ...
      '<span class="pill pill-yellow">🔥 限时</span></div>' +
      ...
      '<th class="center" style="padding:8px 0;width:80px">Pro</th></tr></thead><tbody>' +
      ...
      '</tbody></table></section>' +
      '<section class="mt-10"><h2 class="center">常见问题</h2>' +
      '<div class="mt-4 grid">' +
